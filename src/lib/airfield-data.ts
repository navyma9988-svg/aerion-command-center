...
export const SEED_EVENTS: OpsEvent[] = [
  ...
  },
  {
    id: "EV-0803",
    diff: [
      { field: "ETA", from: "14:18", to: "14:40" },
      { field: "State", from: "Approach", to: "Hold BOOVE" },
    ],
    at: "14:02",
    kind: "flight",
  ...
  },
  {
    id: "EV-0805",
    diff: [
      { field: "Ceiling", from: "700 ft", to: "300 ft" },
      { field: "Minima", from: "CAT I", to: "CAT II" },
      { field: "Spacing", from: "5 NM", to: "6 NM" },
    ],
    at: "14:22",
    kind: "weather",
    severity: "p1",
...
export const INCOMING_EVENTS: OpsEvent[] = [
  {
    id: "EV-0807",
    diff: [
      { field: "ETA", from: "15:04", to: "14:51" },
      { field: "Stand", from: "C14", to: "C17" },
    ],
    at: "14:36",
    kind: "flight",
  ...
  },
  {
    ...
    diff: [
      ...
      { field: "RVR", from: "1,600 ft", to: "1,200 ft" },
    ],
    at: "14:43",
    kind: "weather",
    severity: "p1",
    ...
    detail:
      "Second look at 14:41 CT shows continued deterioration. Consider flow reduction request to Fort Worth Center.",
    tags: ["Airside", "17C/35C", "CAT II"],
    change: "escalated",
    alertId: "DIS-2411",
  },
  ...
  },
  {
    ...
    detail:
      "Airfield ops rolling for a 10 min surface sweep. Expect single-runway departures on the west side.",
  ...
  },
  {
    id: "EV-0813",
    diff: [
      { field: "Off blocks", from: "14:32", to: "14:59" },
      { field: "Delay", from: "+9 min", to: "+27 min" },
    ],
    at: "14:59",
    kind: "flight",
  ...
  },
  {
    id: "EV-0814",
    diff: [
      { field: "Ceiling", from: "300 ft", to: "500 ft" },
      { field: "Minima", from: "CAT II", to: "CAT I review" },
    ],
    at: "15:03",
    kind: "weather",
    title: "Ceiling improving — 500 ft reported, CAT I review at 1515",
    detail:
      "Trend supports returning to 5 NM spacing if it holds for two consecutive observations.",
    tags: ["Airside", "CAT II"],
    change: "cleared",
    alertId: "DIS-2411",
  },
